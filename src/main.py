...
def main():
    ...
    try:
        # Пример вызова homepage_view (используем дату в пределах данных: май 2021)
        ...
        # Пример вызова investment_bank (используем май 2021)
        transactions = [
        ...
        category_report = spending_by_category(transactions_df, "Супермаркеты", "2021-05-20")
